...
public class Client implements Runnable {
    //private Store store;
    private IAF storeIAF;
    private IAPP storeIAPP;
    
    public void initStoreIAF(IAF storeIAF){
    	this.storeIAF = storeIAF;
    	
    }
    
    public void initStoreIAPP(IAPP storeIAPP){
    	this.storeIAPP = storeIAPP;
    }
    ...
    InsufficientBalanceException, UnknownAccountException{        
        ...
        Order order = storeIAF.oneShotOrder(this,item,qty,address,account);
    ...
    UnknownItemException, InvalidCartException{    	
        ...
        for (int i = 0; i < items.length; i++) {
            ...
            cart = storeIAPP.addItemToCart(cart,this,items[i],qties[i]);
        }
        Order order = storeIAPP.pay(cart,address,account);
        System.out.println(order);
    }
